...
class Detailbooks {
  ...
  Detailbooks.fromJson(Map<String, dynamic> json)
      : identifiers = (json['identifiers'] as Map<String, dynamic>?) != null
        ...
        publishers = (json['publishers'] as List?)
            ...
            .toList(),
        covers =
            (json['covers'] as List?)?.map((dynamic e) => e as int).toList(),
        ...
        languages = (json['languages'] as List?)
            ...
            .toList(),
        sourceRecords = (json['source_records'] as List?)
            ?.map((dynamic e) => e as String)
            .toList(),
        localId = (json['local_id'] as List?)
            ?.map((dynamic e) => e as String)
            .toList(),
        type = (json['type'] as Map<String, dynamic>?) != null
            ...
            : null,
        firstSentence =
            (json['first_sentence'] as Map<String, dynamic>?) != null
                ? FirstSentence.fromJson(
                    json['first_sentence'] as Map<String, dynamic>)
                : null,
        key = json['key'] as String?,
        numberOfPages = json['number_of_pages'] as int?,
        works = (json['works'] as List?)
            ?.map((dynamic e) => Works.fromJson(e as Map<String, dynamic>))
            .toList(),
        classifications =
            (json['classifications'] as Map<String, dynamic>?) != null
                ? Classifications.fromJson(
                    json['classifications'] as Map<String, dynamic>)
                : null,
        ocaid = json['ocaid'] as String?,
        isbn10 = (json['isbn_10'] as List?)
            ?.map((dynamic e) => e as String)
            .toList(),
        isbn13 = (json['isbn_13'] as List?)
            ?.map((dynamic e) => e as String)
            .toList(),
        latestRevision = json['latest_revision'] as int?,
        revision = json['revision'] as int?,
        created = (json['created'] as Map<String, dynamic>?) != null
            ? Created.fromJson(json['created'] as Map<String, dynamic>)
            : null,
        lastModified = (json['last_modified'] as Map<String, dynamic>?) != null
            ? LastModified.fromJson(
                json['last_modified'] as Map<String, dynamic>)
            : null;
...
class Identifiers {
  ...
  Identifiers.fromJson(Map<String, dynamic> json)
      : goodreads = (json['goodreads'] as List?)
            ?.map((dynamic e) => e as String)
            .toList(),
        librarything = (json['librarything'] as List?)
            ?.map((dynamic e) => e as String)
            .toList();

  Map<String, dynamic> toJson() =>
      {'goodreads': goodreads, 'librarything': librarything};
}
...
class Authors {
  ...
  Authors.fromJson(Map<String, dynamic> json) : key = json['key'] as String?;
...
class Languages {
  ...
  Languages.fromJson(Map<String, dynamic> json) : key = json['key'] as String?;
...
class Type {
  ...
  Type.fromJson(Map<String, dynamic> json) : key = json['key'] as String?;
...
class Works {
  ...
  Works.fromJson(Map<String, dynamic> json) : key = json['key'] as String?;
