...
import 'package:appbook/components/themes.dart';
    ...
    return TouchableOpacity(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          border: border,
          color: onTap != null ? color : AppbookColors.grayStroke,
        ...
        child: Center(
          child: child ??
              Text(
                text!,
                style: AppbookFonts(context).boldQuicksand(size: 14).apply(
                  color: onTap != null
                      ? textColor
                      : AppbookColors.black.withOpacity(0.6),
                ),
              ),
        ),
      ),
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            colors: [
              AppbookColors.secondary,
              AppbookColors.primary,
            ],
        ...
        child: Center(
            child: Text(
              'LOGIN',
              style: AppbookFonts(context).boldQuicksand(
                color: AppbookColors.lightPrimary,
                size: 14,
              ),
            )),
      ),
